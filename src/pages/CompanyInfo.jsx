        ...
        <section className="company-intro" id="promise" aria-labelledby="promise-title">
          <div className="company-shell company-intro__grid">
            <div>
              ...
              <h2 id="promise-title">메이크원은 세 가지를 약속드립니다.</h2>
            </div>
        ...
        <section className="company-philosophy" id="philosophy" aria-labelledby="philosophy-title">
          ...
          <div className="company-shell company-philosophy__body">
            ...
            <div className="company-philosophy__letter">
              ...
              <p>
                저는 지난 10년이 넘는 시간 동안 기업행사, 체육대회, 학교행사, 축제, 팬미팅 등
                2,000회가 넘는 다양한 현장에서 사람들과 함께해 왔습니다.
              </p>
              <p>
                무대 위에서는 언제나 많은 사람들의 웃음과 박수가 있었지만, 제가 가장 많이 마주한 것은
                무대 뒤에서 행사를 준비하는 담당자의 책임감이었습니다.
              </p>
              <p>행사를 준비하는 분들은 누구보다 많은 고민을 안고 있습니다.</p>
              <p>
                행사는 단 몇 시간으로 끝나지만, 그 결과는 오랫동안 기억됩니다.
                그렇기에 저는 항상 이렇게 생각했습니다.
              </p>
              <p className="company-philosophy__emphasis">
                행사는 프로그램을 운영하는 일이 아니라, 고객의 신뢰를 완성하는 일이라고.
              </p>
              <p>그래서 메이크원 엔터테인먼트를 만들었습니다.</p>
              <div className="company-philosophy__closing">
                <p>행사가 끝난 뒤,</p>
                <p>“이번 행사는 정말 잘됐다.”</p>
                <p>그리고 담당자의 마음속에</p>
                <p>“메이크원과 함께해서 정말 다행이었다.”</p>
                <p>라는 한마디가 남을 수 있도록.</p>
              </div>
              <p>그것이 메이크원 엔터테인먼트가 존재하는 이유입니다.</p>
              <p>감사합니다.</p>
              <p className="company-philosophy__signature">메이크원 엔터테인먼트 대표 <strong>박상설</strong></p>
            </div>
          </div>
        </section>
